...
* Notes:The program creates a good-code.cpp file that copys over the code with no leading white spaces and then a better-code.cpp file is created that copys over that code with the correct indentation
